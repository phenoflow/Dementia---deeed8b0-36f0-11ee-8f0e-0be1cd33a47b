...
steps:
  ...
  dementia-alzheimer---secondary:
    run: dementia-alzheimer---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-dementium---secondary:
    run: dementia-dementium---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-alzheimer---secondary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-dementium---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
